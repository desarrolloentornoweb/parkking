...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { autenticacion_id: @comentario.autenticacion_id, descripcion: @comentario.descripcion, puntuacion: @comentario.puntuacion, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { autenticacion_id: @comentario.autenticacion_id, descripcion: @comentario.descripcion, puntuacion: @comentario.puntuacion, usuario_id: @comentario.usuario_id } }
