...
class AlquilersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alquiler" do
    assert_difference('Alquiler.count') do
      post alquilers_url, params: { alquiler: { fecha: @alquiler.fecha, hora: @alquiler.hora, idEstacionamiento: @alquiler.idEstacionamiento, nhora: @alquiler.nhora, tpago: @alquiler.tpago } }
    end
  ...
  test "should update alquiler" do
    patch alquiler_url(@alquiler), params: { alquiler: { fecha: @alquiler.fecha, hora: @alquiler.hora, idEstacionamiento: @alquiler.idEstacionamiento, nhora: @alquiler.nhora, tpago: @alquiler.tpago } }
